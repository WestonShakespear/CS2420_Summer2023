...
public class wshakespear_AlgorithmAnalysis {
	...
	public void rinse(wshakespear_Functor f)
	{
	...
	public void timeMethodThatNeedsAnInt(wshakespear_Functor f) {
		...
		String outputFormat = "| Progress: %-10s | Size: %10d |%n";
		...
		for(int z = 0; z < sizes.length; z++) {
			...
			System.out.printf(outputFormat, progress, sizes[z]	);
...
class SimpleMethod implements wshakespear_Functor{
