 ...
 */
public class wshakespear_ArrayQueue<AnyType> implements wshakespear_Queue<AnyType>
{
    /**
     * Construct the queue.
     */
    public wshakespear_ArrayQueue( )
    {
        theArray = (AnyType []) new Object[ DEFAULT_CAPACITY ];
        makeEmpty( );
    }
    public wshakespear_ArrayQueue( int _size )
    {
        theArray = (AnyType []) new Object[ _size ];
        makeEmpty( );
    }
    ...
    {
        if( isEmpty( ) )
            throw new wshakespear_UnderflowException( "ArrayQueue dequeue" );
        currentSize--;
    ...
    {
        if( isEmpty( ) )
            throw new wshakespear_UnderflowException( "ArrayQueue getFront" );
