...
public class Assignment_18_Tester {
	...
	public static void main(String [] args) {
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t6) != 5){
			System.err.println("For tree t6, error with numberOfLeaves method: Expected 5 received " + wshakespear_Assignment_18.numberOfLeaves(t6));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t6) != 3){
			System.err.println("For tree t6, error with numberOfNodesWithOneNonNullChild method: Expected 3 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t6));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t6) != 4){
			System.err.println("For tree t6, error with numberOfNodesWithTwoNonNullChildren method: Expected 4 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t6));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t6) != 7){
			System.err.println("For tree t6, error with numberOfNodesWithEvenDataItems method: Expected 7 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t6));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t6) != 607){
			System.err.println("For tree t6, error with sumOfAllItems method: Expected 607 received " + wshakespear_Assignment_18.sumOfAllItems(t6));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t13) != 4){
			System.err.println("For tree t13, error with numberOfLeaves method: Expected 4 received " + wshakespear_Assignment_18.numberOfLeaves(t13));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t13) != 2){
			System.err.println("For tree t13, error with numberOfNodesWithOneNonNullChild method: Expected 2 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t13));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t13) != 3){
			System.err.println("For tree t13, error with numberOfNodesWithTwoNonNullChildren method: Expected 3 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t13));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t13) != 7){
			System.err.println("For tree t13, error with numberOfNodesWithEvenDataItems method: Expected 7 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t13));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t13) != 320){
			System.err.println("For tree t13, error with sumOfAllItems method: Expected 320 received " + wshakespear_Assignment_18.sumOfAllItems(t13));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t20) != 5){
			System.err.println("For tree t20, error with numberOfLeaves method: Expected 5 received " + wshakespear_Assignment_18.numberOfLeaves(t20));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t20) != 2){
			System.err.println("For tree t20, error with numberOfNodesWithOneNonNullChild method: Expected 2 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t20));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t20) != 4){
			System.err.println("For tree t20, error with numberOfNodesWithTwoNonNullChildren method: Expected 4 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t20));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t20) != 4){
			System.err.println("For tree t20, error with numberOfNodesWithEvenDataItems method: Expected 4 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t20));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t20) != 441){
			System.err.println("For tree t20, error with sumOfAllItems method: Expected 441 received " + wshakespear_Assignment_18.sumOfAllItems(t20));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t27) != 6){
			System.err.println("For tree t27, error with numberOfLeaves method: Expected 6 received " + wshakespear_Assignment_18.numberOfLeaves(t27));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t27) != 1){
			System.err.println("For tree t27, error with numberOfNodesWithOneNonNullChild method: Expected 1 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t27));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t27) != 5){
			System.err.println("For tree t27, error with numberOfNodesWithTwoNonNullChildren method: Expected 5 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t27));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t27) != 7){
			System.err.println("For tree t27, error with numberOfNodesWithEvenDataItems method: Expected 7 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t27));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t27) != 447){
			System.err.println("For tree t27, error with sumOfAllItems method: Expected 447 received " + wshakespear_Assignment_18.sumOfAllItems(t27));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t34) != 7){
			System.err.println("For tree t34, error with numberOfLeaves method: Expected 7 received " + wshakespear_Assignment_18.numberOfLeaves(t34));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t34) != 0){
			System.err.println("For tree t34, error with numberOfNodesWithOneNonNullChild method: Expected 0 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t34));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t34) != 6){
			System.err.println("For tree t34, error with numberOfNodesWithTwoNonNullChildren method: Expected 6 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t34));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t34) != 11){
			System.err.println("For tree t34, error with numberOfNodesWithEvenDataItems method: Expected 11 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t34));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t34) != 710){
			System.err.println("For tree t34, error with sumOfAllItems method: Expected 710 received " + wshakespear_Assignment_18.sumOfAllItems(t34));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t41) != 5){
			System.err.println("For tree t41, error with numberOfLeaves method: Expected 5 received " + wshakespear_Assignment_18.numberOfLeaves(t41));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t41) != 2){
			System.err.println("For tree t41, error with numberOfNodesWithOneNonNullChild method: Expected 2 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t41));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t41) != 4){
			System.err.println("For tree t41, error with numberOfNodesWithTwoNonNullChildren method: Expected 4 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t41));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t41) != 4){
			System.err.println("For tree t41, error with numberOfNodesWithEvenDataItems method: Expected 4 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t41));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t41) != 575){
			System.err.println("For tree t41, error with sumOfAllItems method: Expected 575 received " + wshakespear_Assignment_18.sumOfAllItems(t41));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t48) != 7){
			System.err.println("For tree t48, error with numberOfLeaves method: Expected 7 received " + wshakespear_Assignment_18.numberOfLeaves(t48));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t48) != 0){
			System.err.println("For tree t48, error with numberOfNodesWithOneNonNullChild method: Expected 0 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t48));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t48) != 6){
			System.err.println("For tree t48, error with numberOfNodesWithTwoNonNullChildren method: Expected 6 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t48));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t48) != 4){
			System.err.println("For tree t48, error with numberOfNodesWithEvenDataItems method: Expected 4 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t48));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t48) != 653){
			System.err.println("For tree t48, error with sumOfAllItems method: Expected 653 received " + wshakespear_Assignment_18.sumOfAllItems(t48));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t55) != 6){
			System.err.println("For tree t55, error with numberOfLeaves method: Expected 6 received " + wshakespear_Assignment_18.numberOfLeaves(t55));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t55) != 0){
			System.err.println("For tree t55, error with numberOfNodesWithOneNonNullChild method: Expected 0 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t55));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t55) != 5){
			System.err.println("For tree t55, error with numberOfNodesWithTwoNonNullChildren method: Expected 5 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t55));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t55) != 6){
			System.err.println("For tree t55, error with numberOfNodesWithEvenDataItems method: Expected 6 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t55));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t55) != 423){
			System.err.println("For tree t55, error with sumOfAllItems method: Expected 423 received " + wshakespear_Assignment_18.sumOfAllItems(t55));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t62) != 5){
			System.err.println("For tree t62, error with numberOfLeaves method: Expected 5 received " + wshakespear_Assignment_18.numberOfLeaves(t62));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t62) != 2){
			System.err.println("For tree t62, error with numberOfNodesWithOneNonNullChild method: Expected 2 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t62));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t62) != 4){
			System.err.println("For tree t62, error with numberOfNodesWithTwoNonNullChildren method: Expected 4 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t62));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t62) != 3){
			System.err.println("For tree t62, error with numberOfNodesWithEvenDataItems method: Expected 3 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t62));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t62) != 478){
			System.err.println("For tree t62, error with sumOfAllItems method: Expected 478 received " + wshakespear_Assignment_18.sumOfAllItems(t62));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t69) != 5){
			System.err.println("For tree t69, error with numberOfLeaves method: Expected 5 received " + wshakespear_Assignment_18.numberOfLeaves(t69));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t69) != 2){
			System.err.println("For tree t69, error with numberOfNodesWithOneNonNullChild method: Expected 2 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t69));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t69) != 4){
			System.err.println("For tree t69, error with numberOfNodesWithTwoNonNullChildren method: Expected 4 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t69));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t69) != 6){
			System.err.println("For tree t69, error with numberOfNodesWithEvenDataItems method: Expected 6 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t69));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t69) != 543){
			System.err.println("For tree t69, error with sumOfAllItems method: Expected 543 received " + wshakespear_Assignment_18.sumOfAllItems(t69));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t100) != 19){
			System.err.println("For tree t100, error with numberOfLeaves method: Expected 19 received " + wshakespear_Assignment_18.numberOfLeaves(t100));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t100) != 8){
			System.err.println("For tree t100, error with numberOfNodesWithOneNonNullChild method: Expected 8 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t100));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t100) != 18){
			System.err.println("For tree t100, error with numberOfNodesWithTwoNonNullChildren method: Expected 18 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t100));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t100) != 26){
			System.err.println("For tree t100, error with numberOfNodesWithEvenDataItems method: Expected 26 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t100));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t100) != 2035){
			System.err.println("For tree t100, error with sumOfAllItems method: Expected 2035 received " + wshakespear_Assignment_18.sumOfAllItems(t100));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t131) != 20){
			System.err.println("For tree t131, error with numberOfLeaves method: Expected 20 received " + wshakespear_Assignment_18.numberOfLeaves(t131));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t131) != 9){
			System.err.println("For tree t131, error with numberOfNodesWithOneNonNullChild method: Expected 9 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t131));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t131) != 19){
			System.err.println("For tree t131, error with numberOfNodesWithTwoNonNullChildren method: Expected 19 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t131));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t131) != 24){
			System.err.println("For tree t131, error with numberOfNodesWithEvenDataItems method: Expected 24 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t131));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t131) != 2174){
			System.err.println("For tree t131, error with sumOfAllItems method: Expected 2174 received " + wshakespear_Assignment_18.sumOfAllItems(t131));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t162) != 20){
			System.err.println("For tree t162, error with numberOfLeaves method: Expected 20 received " + wshakespear_Assignment_18.numberOfLeaves(t162));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t162) != 9){
			System.err.println("For tree t162, error with numberOfNodesWithOneNonNullChild method: Expected 9 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t162));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t162) != 19){
			System.err.println("For tree t162, error with numberOfNodesWithTwoNonNullChildren method: Expected 19 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t162));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t162) != 29){
			System.err.println("For tree t162, error with numberOfNodesWithEvenDataItems method: Expected 29 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t162));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t162) != 2449){
			System.err.println("For tree t162, error with sumOfAllItems method: Expected 2449 received " + wshakespear_Assignment_18.sumOfAllItems(t162));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t193) != 25){
			System.err.println("For tree t193, error with numberOfLeaves method: Expected 25 received " + wshakespear_Assignment_18.numberOfLeaves(t193));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t193) != 6){
			System.err.println("For tree t193, error with numberOfNodesWithOneNonNullChild method: Expected 6 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t193));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t193) != 24){
			System.err.println("For tree t193, error with numberOfNodesWithTwoNonNullChildren method: Expected 24 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t193));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t193) != 27){
			System.err.println("For tree t193, error with numberOfNodesWithEvenDataItems method: Expected 27 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t193));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t193) != 3086){
			System.err.println("For tree t193, error with sumOfAllItems method: Expected 3086 received " + wshakespear_Assignment_18.sumOfAllItems(t193));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t224) != 21){
			System.err.println("For tree t224, error with numberOfLeaves method: Expected 21 received " + wshakespear_Assignment_18.numberOfLeaves(t224));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t224) != 9){
			System.err.println("For tree t224, error with numberOfNodesWithOneNonNullChild method: Expected 9 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t224));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t224) != 20){
			System.err.println("For tree t224, error with numberOfNodesWithTwoNonNullChildren method: Expected 20 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t224));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t224) != 26){
			System.err.println("For tree t224, error with numberOfNodesWithEvenDataItems method: Expected 26 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t224));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t224) != 2312){
			System.err.println("For tree t224, error with sumOfAllItems method: Expected 2312 received " + wshakespear_Assignment_18.sumOfAllItems(t224));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t255) != 21){
			System.err.println("For tree t255, error with numberOfLeaves method: Expected 21 received " + wshakespear_Assignment_18.numberOfLeaves(t255));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t255) != 6){
			System.err.println("For tree t255, error with numberOfNodesWithOneNonNullChild method: Expected 6 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t255));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t255) != 20){
			System.err.println("For tree t255, error with numberOfNodesWithTwoNonNullChildren method: Expected 20 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t255));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t255) != 26){
			System.err.println("For tree t255, error with numberOfNodesWithEvenDataItems method: Expected 26 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t255));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t255) != 2333){
			System.err.println("For tree t255, error with sumOfAllItems method: Expected 2333 received " + wshakespear_Assignment_18.sumOfAllItems(t255));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t286) != 23){
			System.err.println("For tree t286, error with numberOfLeaves method: Expected 23 received " + wshakespear_Assignment_18.numberOfLeaves(t286));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t286) != 7){
			System.err.println("For tree t286, error with numberOfNodesWithOneNonNullChild method: Expected 7 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t286));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t286) != 22){
			System.err.println("For tree t286, error with numberOfNodesWithTwoNonNullChildren method: Expected 22 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t286));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t286) != 25){
			System.err.println("For tree t286, error with numberOfNodesWithEvenDataItems method: Expected 25 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t286));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t286) != 2817){
			System.err.println("For tree t286, error with sumOfAllItems method: Expected 2817 received " + wshakespear_Assignment_18.sumOfAllItems(t286));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t317) != 20){
			System.err.println("For tree t317, error with numberOfLeaves method: Expected 20 received " + wshakespear_Assignment_18.numberOfLeaves(t317));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t317) != 9){
			System.err.println("For tree t317, error with numberOfNodesWithOneNonNullChild method: Expected 9 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t317));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t317) != 19){
			System.err.println("For tree t317, error with numberOfNodesWithTwoNonNullChildren method: Expected 19 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t317));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t317) != 25){
			System.err.println("For tree t317, error with numberOfNodesWithEvenDataItems method: Expected 25 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t317));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t317) != 2705){
			System.err.println("For tree t317, error with sumOfAllItems method: Expected 2705 received " + wshakespear_Assignment_18.sumOfAllItems(t317));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t348) != 17){
			System.err.println("For tree t348, error with numberOfLeaves method: Expected 17 received " + wshakespear_Assignment_18.numberOfLeaves(t348));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t348) != 13){
			System.err.println("For tree t348, error with numberOfNodesWithOneNonNullChild method: Expected 13 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t348));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t348) != 16){
			System.err.println("For tree t348, error with numberOfNodesWithTwoNonNullChildren method: Expected 16 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t348));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t348) != 22){
			System.err.println("For tree t348, error with numberOfNodesWithEvenDataItems method: Expected 22 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t348));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t348) != 2270){
			System.err.println("For tree t348, error with sumOfAllItems method: Expected 2270 received " + wshakespear_Assignment_18.sumOfAllItems(t348));
		}
		...
		if(wshakespear_Assignment_18.numberOfLeaves(t379) != 20){
			System.err.println("For tree t379, error with numberOfLeaves method: Expected 20 received " + wshakespear_Assignment_18.numberOfLeaves(t379));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t379) != 10){
			System.err.println("For tree t379, error with numberOfNodesWithOneNonNullChild method: Expected 10 received " + wshakespear_Assignment_18.numberOfNodesWithOneNonNullChild(t379));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t379) != 19){
			System.err.println("For tree t379, error with numberOfNodesWithTwoNonNullChildren method: Expected 19 received " + wshakespear_Assignment_18.numberOfNodesWithTwoNonNullChildren(t379));
		}
		if(wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t379) != 25){
			System.err.println("For tree t379, error with numberOfNodesWithEvenDataItems method: Expected 25 received " + wshakespear_Assignment_18.numberOfNodesWithEvenDataItems(t379));
		}
		if(wshakespear_Assignment_18.sumOfAllItems(t379) != 2646){
			System.err.println("For tree t379, error with sumOfAllItems method: Expected 2646 received " + wshakespear_Assignment_18.sumOfAllItems(t379));
		}

		wshakespear_Assignment_18.printRuntimes();
